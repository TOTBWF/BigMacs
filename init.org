...
* Themes
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package wilmersdorf-theme
      :straight (wilmersdorf :type git :host github :repo "ianpan870102/wilmersdorf-emacs-theme"
			     :files ("wilmersdorf-theme.el")))
  #+END_SRC
...
** Jira
   ...
   #+BEGIN_SRC emacs-lisp 
     (use-package org-jira
       ...
       :commands (counsel-jira-find-file)
       :config
...
* LSP
  ...
  Next, let's redefine =g d= when =lsp-mode= is active.
  #+BEGIN_SRC emacs-lisp
