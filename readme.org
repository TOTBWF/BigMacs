...
** TODO Jira
   #+BEGIN_SRC emacs-lisp
     (use-package ejira
       :straight (ejira :type git :host github
                        :repo "nyyManni/ejira")
       :init
       (setq ejira-org-directory "~/jira"))
   #+END_SRC

   #+BEGIN_SRC emacs-lisp
     (defun ejira-browse-issue ()
       (interactive)
...
*** Clojure
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package cider
        ...
        :config
        ;; (general-mode-leader-definer 'cider-mode
        ;;   "j" '(cider-jack-in-cljs :wk "jack"))
        )
    #+END_SRC
** Typescript
